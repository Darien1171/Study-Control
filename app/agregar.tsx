...
export default function AgregarScreen() {
  ...
  const [horaEntrega, setHoraEntrega] = useState<Date>(() => {
    const d = new Date();
    d.setHours(8, 0, 0, 0);
    return d;
  });
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    activo && { backgroundColor: config.color },
                  ]}
            ...
            <View style={styles.opcionesRecordatorio}>
              {OPCIONES_RECORDATORIO.map((op) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.opcionBtn,
                    tiempoRecordatorio === op.value && styles.opcionBtnActivo,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.opcionTexto,
                      tiempoRecordatorio === op.value && styles.opcionTextoActivo,
                    ]}
                  >
                    {op.label}
                  </Text>
